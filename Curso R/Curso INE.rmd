...
setwd('G:/Mi unidad/Universidad/Cursos/Curso Congreso/Intro_R_JNE2019')
knitr::opts_chunk$set(fig.path = "static/img/", echo = TRUE, cache = TRUE)
source("setup.R")
```

# <br><br>Introducción a R<br><small> <br><br> MiDaS</small>{ .center .white data-background="#75AADB" }

## Programa del Curso

- Introducción a `R`: Instalación, Interfaz y Operatoria básica.
- Manipulación de bases de datos en `R`.
-Análisis exploratorio y visualización en `R`.
- Creación de reportes automatizados utilizando `Rmarkdown`.
...
# Análisis exploratorio y visualización en `R`{ .center .white data-background="#75AADB" }
...
Abra el archivo `Actividad_3.pdf` y responda las preguntas en él.
